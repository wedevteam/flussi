...
class RelAgenziePrefView_Model extends Model {
    ...
    public function getRelAgenziePrefList($idAgenzia,$tipoPreferenza,$orderBy) {
        ...
        $result = $this->db->selectWithOrder(TAB_REL_AGENZIE_PREFVIEW, $data, $where, $parameters, false, $orderBy, NULL);
    ...
    public function create($data) {
        // Execute
        $this->db->insert(TAB_REL_AGENZIE_PREFVIEW, $data);
    ...
    public function updateData($data,$parameters,$where) {
        // Execute
        $this->db->update(TAB_REL_AGENZIE_PREFVIEW, $data, $where, $parameters);
        return true;
    ...
    public function getDataFromId($id) {
        ...
        $parameters[":id"] = $id;
        $parameters[":statusDeleted"] = "deleted";
        $result = $this->db->select(TAB_REL_AGENZIE_PREFVIEW, $data, $where, $parameters, true);
        return $result;
    }
